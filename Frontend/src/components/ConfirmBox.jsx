    ...
    <div className="fixed top-0 bottom-0 right-0 left-0 z-50 bg-neutral-800 bg-opacity-75 flex justify-center items-center">
      <div className="w-full max-w-md mx-auto p-4 bg-white rounded">
        <div className="flex justify-between items-center">
          <h1 className="text-lg font-semibold text-slate-800">Confirm</h1>
          <button onClick={close} className="ml-auto">
            <IoClose size={25} />
          </button>
        </div>
        <p className="my-4 text-slate-600">Are you sure you want to confirm</p>
        <div className="w-fit ml-auto flex items-center gap-5 p-2">
          ...
          <button onClick={confirm} className="border border-green-500 text-green-600 hover:bg-green-500 hover:text-white px-4 py-1 rounded">Confirm</button>
        </div>
      </div>
    </div>
  );
